    ...
    <Card className="card-shadow border-border/50 hover:card-shadow-hover transition-all duration-300 animate-fade-in">
      <CardHeader className="pb-4">
        <CardTitle className="text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
          Изготовление новых столешниц
        </CardTitle>
        <CardDescription className="text-base mt-2">Добавьте столешницы для изготовления из дуба</CardDescription>
      </CardHeader>
            ...
            <DialogContent>
              ...
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  <Label htmlFor="quantity-new">Количество столешниц</Label>
                  <Input
                    id="quantity-new"
                    type="number"
                    min="1"
